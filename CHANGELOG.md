...
No significant changes detected since v1.4.39.

## v1.4.39 (patch)

Changes since v1.4.38:

- Bump Polyfill from 11.2.0 to 11.3.0 ([@dependabot[bot]](https://github.com/dependabot[bot]))

## v1.4.38 (patch)

Changes since v1.4.37:

- Bump the ktsu group with 1 update ([@dependabot[bot]](https://github.com/dependabot[bot]))

## v1.4.37 (patch)

No significant changes detected since v1.4.36.
...
No significant changes detected since v1.4.33.
...
## v1.4.6-pre.8 (prerelease)

Changes since v1.4.6-pre.7:

- Merge remote-tracking branch 'refs/remotes/origin/main' ([@ktsu[bot]](https://github.com/ktsu[bot]))
- Sync scripts\update-winget-manifests.ps1 ([@ktsu[bot]](https://github.com/ktsu[bot]))

## v1.4.6-pre.7 (prerelease)

Changes since v1.4.6-pre.6:
...
## v1.4.6-pre.4 (prerelease)

Changes since v1.4.6-pre.3:

- Merge remote-tracking branch 'refs/remotes/origin/main' ([@ktsu[bot]](https://github.com/ktsu[bot]))
- Sync global.json ([@ktsu[bot]](https://github.com/ktsu[bot]))

## v1.4.6-pre.3 (prerelease)

Changes since v1.4.6-pre.2:

- Merge remote-tracking branch 'refs/remotes/origin/main' ([@ktsu[bot]](https://github.com/ktsu[bot]))
- Sync global.json ([@ktsu[bot]](https://github.com/ktsu[bot]))
- Sync COPYRIGHT.md ([@ktsu[bot]](https://github.com/ktsu[bot]))

## v1.4.6-pre.2 (prerelease)

Changes since v1.4.6-pre.1:
...
No significant changes detected since v1.4.2-pre.14.

## v1.4.2-pre.14 (prerelease)

No significant changes detected since v1.4.2-pre.13.

## v1.4.2-pre.13 (prerelease)

No significant changes detected since v1.4.2-pre.12.

## v1.4.2-pre.12 (prerelease)

No significant changes detected since v1.4.2-pre.11.

## v1.4.2-pre.11 (prerelease)

No significant changes detected since v1.4.2-pre.10.

## v1.4.2-pre.10 (prerelease)

No significant changes detected since v1.4.2-pre.9.

## v1.4.2-pre.9 (prerelease)

No significant changes detected since v1.4.2-pre.8.

## v1.4.2-pre.8 (prerelease)

No significant changes detected since v1.4.2-pre.7.

## v1.4.2-pre.7 (prerelease)

No significant changes detected since v1.4.2-pre.6.

## v1.4.2-pre.6 (prerelease)

No significant changes detected since v1.4.2-pre.5.

## v1.4.2-pre.5 (prerelease)

No significant changes detected since v1.4.2-pre.4.

## v1.4.2-pre.4 (prerelease)

No significant changes detected since v1.4.2-pre.3.

## v1.4.2-pre.3 (prerelease)

No significant changes detected since v1.4.2-pre.2.

## v1.4.2-pre.2 (prerelease)

No significant changes detected since v1.4.2-pre.1.
...
- Update ktsu.PreciseNumber package version ([@matt-edmondson](https://github.com/matt-edmondson))
...
- Merge branch 'precise-number' into precise-number-merge ([@matt-edmondson](https://github.com/matt-edmondson))
